...
$expectedGame = 'B82E4946AD23DDCE6CEC96E6255C28B5B97B155E136175146C3A6AD1C10C2984'
$env:HON_HOME = $gameDirectory
$env:THORGOR_HON_HOME = $gameDirectory
$env:PYTHONPATH = $repository
$log = Join-Path $repository 'work\install_reconnect_v17.log'
$stdout = Join-Path $repository 'work\stack_v17.out.log'
$stderr = Join-Path $repository 'work\stack_v17.err.log'
