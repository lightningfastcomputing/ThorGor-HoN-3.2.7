...
$expectedGame = 'EDE947C89F2503612A5CC8835AD730DBC99D4F9D958ADA4A96129D9A58BED856'
$env:HON_HOME = $gameDirectory
$env:THORGOR_HON_HOME = $gameDirectory
$env:PYTHONPATH = $repository
$log = Join-Path $repository 'work\install_reconnect_v16.log'
$stdout = Join-Path $repository 'work\stack_v16.out.log'
$stderr = Join-Path $repository 'work\stack_v16.err.log'
