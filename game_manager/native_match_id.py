...
VERIFIED_GAME_DLL_SHA256S = frozenset((
    ...
    "E73485414DE9EF839EA65273D3BDE179A078DA40DAE9EAAA4E10543433EC12CA",
    "F1DCF44A85AF648A263EB87A573A1EA49D468BC7ED1A9DC6984690767EF406C8",
    "6B9D4396FF499E3F39B2FA8C834482030BC896A164FB843DE219109E016B9766",
    "614EA87B07858531A6F741CB33ED8B9922F5A7D9EA8EE1DC40351437C3A1C01A",
    "CF565B4EAF39FB52ABB925C24E61E96F06B3547417671D733A530E8C28C9AF93",
    "EDE947C89F2503612A5CC8835AD730DBC99D4F9D958ADA4A96129D9A58BED856",
    "B82E4946AD23DDCE6CEC96E6255C28B5B97B155E136175146C3A6AD1C10C2984",
))
                    ...
                    if dll_hash is None:
                        ...
                        if dll_hash not in VERIFIED_GAME_DLL_SHA256S and not args.allow_unknown_game_dll:
                            raise RuntimeError(
                                ...
                                f"sha256={dll_hash} expected_one_of={','.join(sorted(VERIFIED_GAME_DLL_SHA256S))}"
                            )
